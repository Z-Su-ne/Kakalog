...
public class SysDetailController {
    ...
    @GetMapping("/find/kind/{uid}/{year}/{month}/{kind}")
    public Iterable<SysDetail> getDetailByresultandkind(@RequestParam("uid") String uid, @RequestParam("year") String year, @RequestParam("month") String month, @RequestParam("kind") String kind) {
        String result = uid + year + month;
        return service.getDetailByresultandkind(result, kind);
    }

    @GetMapping("/find/kind1/{uid}/{year}/{month}/{kind}")
    public Iterable<SysDetail> getDetailByresultandkind1(@RequestParam("uid") String uid, @RequestParam("year") String year, @RequestParam("month") String month, @RequestParam("kind") String kind) {
        String result = uid + year + month;
        return service.getDetailByresultandkind1(result, kind);
    }

    @GetMapping("/find/kind2/{uid}/{year}/{month}/{kind}")
    public Iterable<SysDetail> getDetailByresultandkind2(@RequestParam("uid") String uid, @RequestParam("year") String year, @RequestParam("month") String month, @RequestParam("kind") String kind) {
        String result = uid + year + month;
        return service.getDetailByresultandkind2(result, kind);
    }

    @GetMapping("/find/kind3/{uid}/{year}/{month}/{kind}")
    public Iterable<SysDetail> getDetailByresultandkind3(@RequestParam("uid") String uid, @RequestParam("year") String year, @RequestParam("month") String month, @RequestParam("kind") String kind) {
        String result = uid + year + month;
        return service.getDetailByresultandkind3(result, kind);
    }

    @GetMapping("/find/kind0/{uid}/{year}/{month}/{kind}")
    public Iterable<SysDetail> getDetailBykind0(@RequestParam("uid") String uid, @RequestParam("year") String year, @RequestParam("month") String month, @RequestParam("kind") String kind) {
        String result = uid + year + month;
        return service.getDetailBykind0(result);
    }
