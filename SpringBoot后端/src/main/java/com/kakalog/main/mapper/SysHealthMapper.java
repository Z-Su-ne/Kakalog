...
public interface SysHealthMapper extends BaseMapper<SysHealth> {
    ...
    public void insert(@Param("uid") String uid, @Param("sex") String sex, @Param("age") Integer age,
                 @Param("height") Double height, @Param("weightTarget") Double weightTarget, @Param("bmi") Double bmi, @Param("weightCurrent") Double weightCurrent, @Param("weightLast") Double weightLast, @Param("caloriesDaily") Double caloriesDaily);
}
