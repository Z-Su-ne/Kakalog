...
Component({
  ...
  methods: {
    ...
    toUpdate(event){
      const pid1=this.data.pid;
      console.log('给下一个页面接收到的pid1:', pid1);
      // let str=JSON.stringify(event.currentTarget.dataset.pid1);
      // console.log('给下一个页面接收到的pid:', str);
    
      wx.navigateTo({
        url: `/pages/goods/goodsUpdate/goodsInfo?pid1=${pid1}`, // 传递食物pid到goodsInfo页面
